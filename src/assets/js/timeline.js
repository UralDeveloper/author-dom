window.addEventListener('scroll', function() {
    var elements = document.querySelectorAll('.timeLine-item[data-step^="step-"]');
    ...
    elements.forEach(function(element) {
      ...
      if (rect.top <= window.innerHeight / 2 && rect.bottom >= window.innerHeight / 2) {
          ...
          let image = document.querySelector(`.step_img[data-step-id=${el_attr}]`);
...
function handleScroll() {
  ...
  // Выводим результат
  let timeLine = document.querySelector('.timeLine-line_load');
